        ...
        lg:flex-row lg:justify-start ">
            ...
            <div className="flex flex-col justify-center text-left lg:items-start">
                ...
                <p className=" text-[var(--color-text-p)] md:w-[55ch] lg:w-[75ch]"> <br />Me llamo Wilberth Ortiz (Berth), Soy desarrollador web 💻 con experiencia en WordPress, especializado en crear sitios funcionalesr para emprendedores y pequeñas empresas.
                    ...
                    <br></br><br></br>Actualmente, estoy ampliando mis habilidades como desarrollador front-end, enfocándome en JavaScript y React para ofrecer soluciones más personalizadas.<br></br>Me encanta encontrar soluciones mediante el código y seguir aprendiendo nuevas tecnologías que me permitan entregar resultados con calidad profesional.<br></br><br></br>Me encanta lo que hago <span>❤️</span> </p>
